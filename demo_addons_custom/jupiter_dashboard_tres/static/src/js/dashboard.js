odoo.define('jupiter_dashboard_tres.JupiterDashboardTres', function (require) {
    'use strict';
    ...
    var _t = core._t;
    var QWeb = core.qweb;
    var JupiterDashboardTres = AbstractAction.extend({
        template: 'JupiterDashboardTres',
        events: {
...
//        Graph 2
        ...
        onChangeManPowerDate: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/manpower_productivity', 'call', {frequency: false, count_or_value: count_or_value, date_from, date_to}, {shadow:true}).then(function (result){
//                self.ManPowerProductivityRadialChart(result[0])
        ...
        linkToList: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/call_list_view', 'call',
        ...
        linkToReport: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/call_report', 'call',
        ...
        manPowerRadioRadio: function(ev){
            ...
            if (custom_range){
                ...
                $('.manpower_loader').removeClass('invisible')
                ajax.jsonRpc('/jupiter_dashboard_tres/manpower_productivity', 'call', {frequency: frequency, count_or_value: count_or_value}, {shadow:true}).then(function (result){
        //                self.ManPowerProductivityRadialChart(result[0])
                    $('#man_power_radial_chart').empty().append(result[0])
                    self.ManPowerProductivityRegionChart(result[1])
                    self.ManPowerProductivityClusterChart(result[2])
        ...
        onChangeCpUnitRegionWiseRadio: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/cp_booking_units_region_wise', 'call', {'model': model, 'frequency': frequency, 'custom_start': custom_start, 'custom_end': custom_end}, {shadow:true}).then(function(result){
        ...
        onChangeWalkInCluster: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/walk_in_data', 'call', {'model': 'project', 'frequency': frequency, 'region': region, 'cluster': cluster_ids}, {shadow:true}).then(function(result){
        ...
        onChangeWalkInRegion: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/walk_in_get_cluster', 'call', {region: region}, {shadow:true}).then(function (result) {
        ...
        onChangeWalkInRegionClusterRadio: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/walk_in_data', 'call', {'model': model, 'frequency': frequency}, {shadow:true}).then(function(result){
        ...
        onChangeCP20Radio: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/get_top_20_cp', 'call', {'frequency': frequency, 'custom_start': custom_start, 'custom_end': custom_end}, {shadow:true}).then(function (result){
...
//        Graph 2
        ...
        onChangeConfiguration: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/sales_inventory', 'call', {'region_wise': false, 'project_wise': true, 'project_region': region, 'configuration_ids': configuration_ids, 'cluster_ids': cluster_ids}, {shadow:true}).then(function (result) {
        ...
        onChangeRegion: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/get_cluster', 'call', {region: region}, {shadow:true}).then(function (result) {
        ...
        changeClusterCheckbox: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/get_last_6_month_cp_booking', 'call', {cluster_ids: cluster_ids}, {shadow:true}).then(function (result) {
        ...
        changeRegionSelect: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/get_cluster_select_data', 'call', {region_ids: region_ids}, {shadow:true}).then(function (result) {
                $('.cluster-select-div').empty().append(result)
            })
            ajax.jsonRpc('/jupiter_dashboard_tres/get_last_6_month_cp_booking', 'call', {region_ids: region_ids}, {shadow:true}).then(function (result) {
                self.applyCpBookingChart(result)
            })
        },
        ...
        changeRadioActualBudget: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/budget_actual_comparison', 'call', {'booking_type': booking_type, 'registration_type': registration_type}, {shadow:true}).then(function (result) {
...
//          'region_or_cluster': 'project'
            ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations_region_wise', 'call', {'frequency': frequency, 'region_ids': region_ids, 'count_or_value': count_or_value, 'region_or_cluster': 'project', 'parent_region': parent_region, 'project_ids': project_ids, 'custom_start': custom_start, 'custom_end': custom_end}, {shadow:true}).then(function (result) {
                if (type == 'gross'){
...
//            'region_or_cluster': 'cluster'
            ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations_region_wise', 'call', {'frequency': frequency, 'region_ids': region_ids, 'count_or_value': count_or_value, 'region_or_cluster': 'cluster', 'parent_region': parent_region, 'custom_start': custom_start, 'custom_end': custom_end}, {shadow:true}).then(function (result) {
                if (type == 'gross'){
                    var data =  result[0][0]['data']
                }else if (type == 'cancelled'){
                    var data =  result[0][1]['data']
        ...
        changeRegionWiseSelect: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations_region_wise', 'call', {'frequency': frequency, 'region_ids': region_ids, 'count_or_value': count_or_value, 'custom_from': custom_from, 'custom_to': custom_to}, {shadow:true}).then(function (result) {
                if (type == 'gross'){
                    var data =  result[0][0]['data']
                }else if (type == 'cancelled'){
                    var data =  result[0][1]['data']
...
//            'region_or_cluster': 'cluster'
        ...
        changeRadioRegionWise: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations_region_wise', 'call', {'frequency': frequency, 'region_ids': region_ids, 'count_or_value': count_or_value, 'custom_start': custom_start, 'custom_end': custom_end}, {shadow:true}).then(function (result) {
...
//        Graph 2 - AJAX request to the server to fetch data  processes chart
        changeRadioRegionWise2: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations_region_wise2', 'call', {'frequency': frequency, 'region_ids': region_ids, 'count_or_value': count_or_value, 'custom_start': custom_start, 'custom_end': custom_end}, {shadow:true}).then(function (result) {
...
//        Graph 2 chart configuration (Booking, Cancelled, and Registration) - ApexCharts
        ...
        changeProject: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations', 'call', {'project': project_ids}, {shadow:true}).then(function (result) {
        ...
        changeCluster: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations', 'call', {'cluster': cluster_ids, 'region': region_ids}, {shadow:true}).then(function (result) {
                self.applyClusterBookingRegistration(result)
                ajax.jsonRpc('/jupiter_dashboard_tres/get_project_data', 'call', {'cluster': cluster_ids, 'region': region_ids}, {shadow:true}).then(function (result1) {
        ...
        changeRegion: function(ev){
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations', 'call', {'region': region_ids}, {shadow:true}).then(function (result) {
                self.applyRegionBookingRegistration(result)
                self.changeRadioRegionWise()
                ajax.jsonRpc('/jupiter_dashboard_tres/get_cluster_data', 'call', {'region': region_ids}, {shadow:true}).then(function (result1) {
                    $('#cluster-container').empty().append(result1)
                    self.applyClusterBookingRegistration(result)
                    self.changeRadioClusterWise()
                })
                ajax.jsonRpc('/jupiter_dashboard_tres/get_project_data', 'call', {'region': region_ids}, {shadow:true}).then(function (result2) {
...
//        Graph 2 dashboard iii Process of selecting one or more Regions from the UI
        changeRegion2: function(ev){
           ...
           var frequency2 = $('.region_wise_radio2:checked').val();
            ...
            ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations_region_wise2', 'call', {'frequency': frequency2, 'region_ids': region_ids2, 'count_or_value': count_or_value2, 'custom_start': custom_start2, 'custom_end': custom_end2}, {shadow:true}).then(function (result) {
                    self.applyRegionWiseChart2(result)
...
//      user based dashboard project configuration
                ajax.jsonRpc('/jupiter_dashboard_tres/get_project_configuration_data', 'call', {}, {shadow:true}).then(function (result) {
//                    if (!result[0]){
...
//                    $('#project_2_dashboard').removeClass('d-none')
                ...
                ajax.jsonRpc('/jupiter_dashboard_tres/get_region_data', 'call', {}, {shadow:true}).then(function (result) {
                ...
                ajax.jsonRpc('/jupiter_dashboard_tres/get_region_data2', 'call', {}, {shadow:true}).then(function (result) {
            ...
            $('.region-blocks2').each(function(i, obj) {
             ...
             var custom_end2 = false
                ...
                ajax.jsonRpc('/jupiter_dashboard_tres/get_cluster_data', 'call', {}, {shadow:true}).then(function (result) {
                    $('#cluster-container').empty().append(result)
                })
                ajax.jsonRpc('/jupiter_dashboard_tres/get_project_data', 'call', {}, {shadow:true}).then(function (result) {
            ...
            $('.region-blocks').each(function(i, obj) {
                ...
                ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations', 'call', {}, {shadow:true}).then(function (result) {
                ...
                ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations_region_wise', 'call', {'frequency': 'month'}, {shadow:true}).then(function (result) {
                    self.applyRegionWiseChart(result)
                    self.applyRegionWiseBookingChart(result[0][0]['data'], result[1])
                    self.applyRegionWiseRegistrationChart(result[0][3]['data'], result[1])
                })
//                'region_or_cluster': 'cluster'
                ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations_region_wise', 'call', {'frequency': 'month', 'region_or_cluster': 'cluster'}, {shadow:true}).then(function (result) {
                    self.applyClusterWiseChart(result)
                    self.applyClusterWiseBookingChart(result[0][0]['data'], result[1])
                    self.applyClusterWiseRegistrationChart(result[0][3]['data'], result[1])
                })
//                 'region_or_cluster': 'project'
                ajax.jsonRpc('/jupiter_dashboard_tres/bookings_registrations_region_wise', 'call', {'frequency': 'month', 'region_or_cluster': 'project'}, {shadow:true}).then(function (result) {
                    self.applyProjectWiseChart(result)
                    self.applyProjectWiseBookingChart(result[2]['gross']['values'], result[2]['gross']['categories'])
                    self.applyProjectWiseRegistrationChart(result[2]['registration']['values'], result[2]['registration']['categories'])
                })
                ajax.jsonRpc('/jupiter_dashboard_tres/budget_actual_comparison', 'call', {'registration_type': false}, {shadow:true}).then(function (result) {
                    self.ActualBudgetComparison(result, 'booking')
                })
                ajax.jsonRpc('/jupiter_dashboard_tres/cp_booked_count', 'call', {}, {shadow:true}).then(function (result) {
                ...
                ajax.jsonRpc('/jupiter_dashboard_tres/get_cp_count', 'call', {}, {shadow:true}).then(function (result) {
                ...
                ajax.jsonRpc('/jupiter_dashboard_tres/get_last_6_month_cp_booking', 'call', {}, {shadow:true}).then(function (result) {
                    self.applyCpBookingChart(result)
                })
                ajax.jsonRpc('/jupiter_dashboard_tres/get_region_select_data', 'call', {}, {shadow:true}).then(function (result) {
                    $('#region_select').empty().append(result)
                    $('#region_select').select2()
                })
                ajax.jsonRpc('/jupiter_dashboard_tres/get_cluster_select_data', 'call', {}, {shadow:true}).then(function (result) {
                    $('.cluster-select-div').empty().append(result)
                })
                ajax.jsonRpc('/jupiter_dashboard_tres/sales_inventory', 'call', {'region_wise': false, 'project_wise': true, 'project_region': false}, {shadow:true}).then(function (result) {
                    self.projectOrRegionFlatStatus(result, true, true)
                })
                ajax.jsonRpc('/jupiter_dashboard_tres/get_region', 'call', {}, {shadow:true}).then(function (result) {
                ...
                ajax.jsonRpc('/jupiter_dashboard_tres/get_cluster', 'call', {}, {shadow:true}).then(function (result) {
                    $('#cluster_select_div').empty().append(result)
                    $('#cluster_select').select2()
                })
                ajax.jsonRpc('/jupiter_dashboard_tres/walk_in_get_cluster', 'call', {}, {shadow:true}).then(function (result) {
                    $('#walk_in_cluster_select_div').empty().append(result)
                    $('#walk_in_cluster_select').select2()
                })
                ajax.jsonRpc('/jupiter_dashboard_tres/get_top_20_cp', 'call', {}, {shadow:true}).then(function (result){
                    $('#cp_tbody').empty().append(result)
                })
                $('.manpower_loader').removeClass('invisible')
                ajax.jsonRpc('/jupiter_dashboard_tres/manpower_productivity', 'call', {frequency: 'month'}, {shadow:true}).then(function (result){
//                    self.ManPowerProductivityRadialChart(result[0])
                    $('#man_power_radial_chart').empty().append(result[0])
                    self.ManPowerProductivityRegionChart(result[1])
                    self.ManPowerProductivityClusterChart(result[2])
                ...
                ajax.jsonRpc('/jupiter_dashboard_tres/walk_in_data', 'call', {}, {shadow:true}).then(function(result){
                    if(result == 'disable'){
...
//                        $('#walk_in_conversion_row').removeClass('d-none')
                ...
                $('#walk_in_project_loader').show()
                $('.walk_in_project_div table').css({'filter': 'blur(4px)'})
                ajax.jsonRpc('/jupiter_dashboard_tres/walk_in_data', 'call', {'model': 'project'}, {shadow:true}).then(function(result){
                    if(result == 'disable'){
                        $('#walk_in_conversion_row').addClass('d-none')
                    }else{
                        $('#walk_in_project_tbody').empty().append(result)
...
//                        $('#walk_in_conversion_row').removeClass('d-none')
                ...
                ajax.jsonRpc('/jupiter_dashboard_tres/cp_booking_units_region_wise', 'call', {'model': 'region'}, {shadow:true}).then(function(result){
                    self.CpBookingUnitsRegionWise(result, 'Region')
                })
            })
        },
    })
    core.action_registry.add('jupiter_dashboard_tres', JupiterDashboardTres);
    return JupiterDashboardTres;
});