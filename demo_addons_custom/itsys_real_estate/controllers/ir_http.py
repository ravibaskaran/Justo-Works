    ...
    def _get_record_and_check(self, xmlid=None, model=None, id=None, field='datas', access_token=None):
        ...
        try:
            ...
            try:
                ...
                if not record.env.su and (record._name == 'ir.attachment' and record.res_model not in (
                'building.attachment.line', 'registration.attachment.line', 'reservation.attachment.line')):
                    record._cache.clear()
