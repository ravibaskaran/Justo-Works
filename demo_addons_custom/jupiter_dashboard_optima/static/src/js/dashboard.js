...
//            console.log("Clicked open-region-modal-btn")
            ...
            var self = this;
                ...
                var $searchInput = this.$('#region-search-input');
                // ──── STEP 2: Show the modal ────
                this.$modal.modal('show');

                // ──── STEP 3: Focus the search input and trigger search when modal opens
                this.$modal.on('shown.bs.modal', function () {
                    // Clear any old value in the search input
                    $searchInput.val('');
                    // Trigger the search immediately when the modal is opened
                    self._fetchRegions('');  // This makes sure the regions are fetched initially
...
//            console.log("Clicked open-cluster-modal-btn")
            ...
            var self = this;
                ...
                var $searchInput = this.$('#cluster-search-input');
                // ──── STEP 2: Show the modal ────
                this.$modal.modal('show');
                ...
                this.$modal.on('shown.bs.modal', function () {
                    ...
                    $searchInput.val('');
                    // Trigger the search immediately when the modal is opened
                    self._fetchClusters('');  // This makes sure the regions are fetched initially
...
//            console.log("Clicked open-project-modal-btn")
            ...
            var self = this;
                ...
                var $searchInput = this.$('#project-search-input');
                // ──── STEP 2: Show the modal ────
                this.$modal.modal('show');
                ...
                this.$modal.on('shown.bs.modal', function () {
                    ...
                    $searchInput.val('');
                    // Trigger the search immediately when the modal is opened
                    self._fetchProjects('');  // This makes sure the regions are fetched initially
...
//            console.log("Clicked open-clusterhead-modal-btn")
            ...
            var self = this;
                ...
                var $searchInput = this.$('#clusterhead-search-input');
                // ──── STEP 2: Show the modal ────
                this.$modal.modal('show');
                ...
                this.$modal.on('shown.bs.modal', function () {
                    ...
                    $searchInput.val('');
                    // Trigger the search immediately when the modal is opened
                    self._fetchClusterHeads('');  // This makes sure the regions are fetched initially
